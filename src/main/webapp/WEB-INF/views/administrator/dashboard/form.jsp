...
<table class="table table-sm" aria-label="dashboard tasks">
	<tr>
		<th scope="row">
...
<table class="table table-sm" aria-label="dashboard Workload">
	<tr>
		<th scope="row">
...
<table class="table table-sm" aria-label="dashboard Execution Period">
	<tr>
		<th scope="row">
